...
```{r print-limit, exercise = TRUE, exercise.eval=TRUE, exercise.lines = 5, exercise.setup="loadpkg"}
tannercrab
```
...
```{r columnWidth, exercise = TRUE, exercise.lines = 5, exercise.setup="loadpkg"}
...
```{r meanwidth, exercise = TRUE, exercise.lines = 5, exercise.setup="loadpkg"}
mean()
```
...
```{r chelamean, exercise = TRUE, exercise.lines = 5, exercise.setup="loadpkg"}
...
```{r bug-tanner, exercise = TRUE, exercise.lines = 5, exercise.setup="loadpkg"}
Mean(Tannercrab$chela, Na.rm = TRUE)
```
