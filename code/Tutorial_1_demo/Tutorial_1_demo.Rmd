...
tutorial:
  id: "com.example.tutorials.learnrdemo"
  version: 1.1.0
output: 
  learnr::tutorial:
    progressive: true
...
*This is a simple "app" that we wrote to go through the exercises we'll cover. In each code chunk, you can evaluate the line in R by clicking "Run Code" or just like in RStudio, you can type "Ctrl+Enter". Note! clicking Run Code will evaluate everything in your box; Ctrl+Enter will evaluate only the current line.*  
...
**NOTE:**   
_There are two ways to run this app. You are probably using the online version which is great! We have also included the code in the folder for this course; you can run it locally on your machine by opening the file, then clicking "Run Document". You will have to install one tiny thing first; ask your instructors!_

<br>  

_If you are working online, please click continue! If you are working locally, read below for a special note._

_When closing out of a tutorial and returning to work again later, you may encounter random errors in datasets not loading properly. To address this, you can do one of two things:_  
...
*Note also that if you're truly stuck, you can just click "Continue". Asking a neighbor for help is also a great option. For instance, the code below is something we haven't covered!*
