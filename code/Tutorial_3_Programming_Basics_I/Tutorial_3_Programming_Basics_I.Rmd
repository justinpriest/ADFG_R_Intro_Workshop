...
Modify the second line of the code below to multiply all elements by 10.
...
Modify the code below to compute the square root of all whole numbers from 1 to 50.  
...
Modify the code below to compute the mean, median, and standard deviation of `x`.  
...
Modify it to give the _actual_ arithmetic mean of the vector of numbers.
